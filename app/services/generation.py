...
from app.db import create_job, consume_credit

async def start_generation(bot, tg_user_id: int, photo_file_id: str, kind: str, product_info: dict, extra_wishes: str | None, template_id: str):
    # 1) скачать фото
