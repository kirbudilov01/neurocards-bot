...
echo "▶️  Starting bot polling service..."
systemctl enable neurocards-bot-polling
systemctl start neurocards-bot-polling
...
echo ""
echo "📊 Status:"
systemctl status neurocards-bot-polling --no-pager | head -10 || true
echo ""
for i in {1..5}; do
    echo "Worker $i:"
